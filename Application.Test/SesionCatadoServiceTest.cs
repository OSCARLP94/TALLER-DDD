...
namespace Application.Test
{
    ...
    public class SesionCatadoServiceTest
    {
        ...
        public void Can_Add_SesionCatado()
        {
            //Arrange
            string Id = "3";
            SesionCatado emp = new SesionCatado() { FechaInicio = new DateTime(2008, 6, 1, 7, 47, 0), IdCiudad = "311", Identificador = "Digitos", Protocolo = "Arabica", Muestras = 1, IdPerson = "201", Estado = "Incompleto" };
